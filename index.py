...
#                         # download button
#                         st.download_button(
#                             label=f"Click here to download {file.name}",
#                             data=buffer,
#                             file_name=file_name,
#                             mime=mime_type
#                         )
...
# st.success("Thank you for using Data Sweeper. Please give us a star on GitHub if you liked it.")
